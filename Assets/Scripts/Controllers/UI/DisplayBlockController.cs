...
namespace Wyd.Controllers.UI
{
    public class DisplayBlockController : MonoBehaviour
    {
        ...
        public void InitializeAs(ItemStack itemStack)
        {
            ...
            // if (BlockController.Current.GetUVs(BlockId, Direction.Up, out BlockUVs blockUVs))
            // {
            //     _UVs.Add(blockUVs[0]);
            //     _UVs.Add(blockUVs[2]);
            //     _UVs.Add(blockUVs[1]);
            ...
            // if (BlockController.Current.GetUVs(BlockId, Direction.North, out blockUVs))
            // {
            //     _UVs.Add(blockUVs[1]);
            //     _UVs.Add(blockUVs[3]);
            //     _UVs.Add(blockUVs[0]);
            ...
            // if (BlockController.Current.GetUVs(BlockId, Direction.East, out blockUVs))
            // {
            //     _UVs.Add(blockUVs[0]);
            //     _UVs.Add(blockUVs[1]);
            //     _UVs.Add(blockUVs[2]);
