...
public static class Mathv
{
    ...
    public static Vector3 Floor(this Vector3 a) => new Vector3(Mathf.Floor(a.x), Mathf.Floor(a.y), Mathf.Floor(a.z));

    public static Vector3 Ceil(this Vector3 a) => new Vector3(Mathf.Ceil(a.x), Mathf.Ceil(a.y), Mathf.Ceil(a.z));

    public static Vector3 Trunc(this Vector3 a) => new Vector3((float) Math.Truncate(a.x), (float) Math.Truncate(a.x),
        (float) Math.Truncate(a.x));

    public static bool AllLessThan(this Vector3 a, Vector3 b) => (a.x < b.x) && (a.y < b.y) && (a.z < b.z);

    public static bool AllLessThanOrEqual(this Vector3 a, Vector3 b) => (a.x <= b.x) && (a.y <= b.y) && (a.z <= b.z);

    public static bool AllGreaterThan(this Vector3 a, Vector3 b) => (a.x > b.x) && (a.y > b.y) && (a.z > b.z);

    public static bool AllGreaterThanOrEqual(this Vector3 a, Vector3 b) => (a.x >= b.x) && (a.y >= b.y) && (a.z >= b.z);

    public static bool AnyGreaterThanOrEqual(this Vector3 a, Vector3 b) => (a.x >= b.x) || (a.y >= b.y) || (a.z >= b.z);
