...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        [SerializeField]
        private Mode m_graphyMode = Mode.FULL;
        ...
        [SerializeField]
        private Color m_monoRamColor = new Color(0.3f, 0.65f, 1f, 1);
        ...
        public bool EnableOnStartup { get; } = true;
        ...
        private bool CheckFor1KeyPress(KeyCode key) => Input.GetKeyDown(key);
        ...
        private bool CheckFor3KeyPress(KeyCode key1, KeyCode key2, KeyCode key3) =>
            (Input.GetKeyDown(key1) && Input.GetKey(key2) && Input.GetKey(key3))
